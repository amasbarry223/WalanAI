...
const mockUsers: AdminUser[] = [
  ...
  { id: '7', name: 'Admin Principal', email: 'admin@walanai.fr', plan: 'pro', role: 'super-admin', active: true, documents: 0, flashcards: 0, quizzes: 0, joinedAt: '1 Jan 2026', lastActive: 'Il y a 2 min', streak: 0, score: 0 },
          ...
          <div className="relative z-10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-slate-400 text-sm mt-1">Gérez les comptes, rôles et permissions</p>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30">{totalUsers} utilisateurs</Badge>
              </div>
            </div>
          </div>
        </div>
